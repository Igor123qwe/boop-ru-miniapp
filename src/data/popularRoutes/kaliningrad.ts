...
export const KALININGRAD_ROUTES: PopularRoute[] = [
  ...
  // ─────────────────────────
  {
    ...
    // городской маршрут по основным точкам + форт №5
    yandexMapUrl:
  ...
  // ─────────────────────────
  {
    ...
    // общий авто-маршрут: Калининград → Светлогорск → Янтарный → обратно
    yandexMapUrl:
    ...
    days: [
      {
        ...
        points: [
          ...
          },
          {
            time: '11:30',
            title: 'Музей Мирового океана',
            description: 'Подлодка Б-413, «Витязь», набережная у Pregolya River.'
          },
          {
            time: '13:30',
          ...
          },
          {
            time: '15:00',
            title: 'Верхнее озеро и парк «Юность»',
            description: 'Колесо обозрения, аттракционы, велопрогулка вокруг озера.'
          },
          {
            time: '18:00',
            title: 'Форт №5',
  ...
  // ─────────────────────────
  {
    ...
    // общий маршрут: Калининград → Светлогорск → Янтарный → Зеленоградск → Куршская коса
    yandexMapUrl:
    ...
    days: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            time: '15:00',
            title: 'Прогулка по одной из троп (Высота Эфа / Танцующий лес)',
            description:
